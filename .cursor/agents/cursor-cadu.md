...
- **VPS-ready:** `.env` raiz = fonte da verdade (sync → backend); `verify:env`; proíbe user `postgres` em production; FE default `/api`; `trust proxy`; guia `docs/projeto/deploy-vps.md`.
